...
import (
	...
	"github.com/flipped-aurora/gin-vue-admin/server/model/emplyeeStructDetail0"
	"go.uber.org/zap"
	"gorm.io/gorm"
)
...
func RegisterTables(db *gorm.DB) {
	err := db.AutoMigrate(
		...
		Employeemanagementui.EmployeeModification{},
		Order_Information.OrderLnformation{},
		emplyeeStructDetail0.EmplyeeStructDetail0{},
